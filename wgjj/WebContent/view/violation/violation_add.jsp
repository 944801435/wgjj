...
<body>
<form id="inputForm" action="${pageContext.request.contextPath }/violationAdd.action" method="post" class="form-horizontal">
		...
		<div class="right_content_all">
			...
			<div class="right_content_select">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="model" autocomplete="off" type="text" dataType="Limit" len="200" msg="请输入(1~200)个字符！" maxlength="200" class="required" name="model" value=""/>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea rows="5" cols="30" id="info" name="info" value="" type="text" dataType="Limit" len="500" msg="请输入(1~500)个字符！" maxlength="500"></textarea>
					</div>
				</div>
			</div>
