...
<body>
<form id="inputForm" action="${pageContext.request.contextPath }/unitDictEdit.action" method="post" class="form-horizontal">
	<input type="hidden" name="dictId" value="${unitDict.dictId }" />
		...
		<div class="right_content_all">
			...
			<div class="right_content_select">
				<div class="control-group">
					...
					<div class="controls">
						<input id="unitName" autocomplete="off" type="text" dataType="Require,Limit" len="50" msg="请输入(1~50)个字符的单位字典名称！" maxlength="50" class="required" name="unitName" value="${unitDict.unitName }"/>
					</div>
				</div>
			</div>
